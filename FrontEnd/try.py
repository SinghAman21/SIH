...
app.mount("/templates/css", StaticFiles(directory=os.path.join(BASE_DIR, "templates/css")), name="css")
app.mount("/templates/js", StaticFiles(directory=os.path.join(BASE_DIR, "templates/js")), name="js")
app.mount("/templates/img", StaticFiles(directory=os.path.join(BASE_DIR, "templates/img")), name="img")
